...
pub use hexa_exec_server::EnvironmentManager;
pub use hexa_exec_server::ExecServerRuntimePaths;
...
mod tests {
    ...
    async fn remote_typed_request_roundtrip_works() {
        ...
        assert_eq!(client.codex_home(), Some("/server/.hexa"));
