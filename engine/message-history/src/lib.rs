...
//!
//! The history is stored at `~/.hexashell/history.jsonl` with **one JSON object per
...
/// Filename that stores the message history inside `~/.hexashell`.
...
pub async fn append_entry(
    ...
    // Resolve `~/.hexashell/history.jsonl` and ensure the parent directory exists.
