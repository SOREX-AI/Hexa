...
/// Expected structure for $HEXA_ENGINE_HOME/auth.json.
...
impl FileAuthStorage {
    ...
    /// Attempt to read and parse the `auth.json` file in the given `HEXA_ENGINE_HOME` directory.
...
const KEYRING_SERVICE: &str = "Hexa Auth";
