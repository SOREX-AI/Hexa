...
pub async fn run_command_under_seatbelt(
    ...
    hexa_linux_sandbox_exe: Option<PathBuf>,
...
pub async fn run_command_under_seatbelt(
    ...
    _hexa_linux_sandbox_exe: Option<PathBuf>,
...
async fn run_command_under_sandbox(
    ...
    let hexa_linux_sandbox_exe = match sandbox_state.as_ref() {
        Some(state) => {
            ...
            state
                .hexa_linux_sandbox_exe
                .clone()
                .or(hexa_linux_sandbox_exe)
        }
        None => hexa_linux_sandbox_exe,
    };
    ...
    let mut child = match sandbox_type {
        ...
        SandboxType::Landlock => {
            ...
            let hexa_linux_sandbox_exe = config
                .hexa_linux_sandbox_exe
                .expect("hexa-linux-sandbox executable not found");
...
async fn load_debug_sandbox_config_with_codex_home(
    ...
    // For legacy configs, `hexa-engine sandbox` historically defaulted to read-only
    ...
    let config = build_debug_sandbox_config_with_loader_overrides(
        ...
        ConfigOverrides {
            cwd: cwd.clone(),
            hexa_linux_sandbox_exe: hexa_linux_sandbox_exe.clone(),
            ..Default::default()
        },
        codex_home.clone(),
        managed_requirements_mode,
