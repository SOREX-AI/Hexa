...
const CODEX_BUNDLE_IDENTIFIER: &str = "com.hexa.engine";
...
mod tests {
    ...
    fn finds_chatgpt_app_with_codex_bundle_identifier() {
        ...
        write_app_bundle(&app_path, "com.hexa.engine");
    ...
    fn ignores_classic_chatgpt_app() {
        ...
        write_app_bundle(&codex_app_path, "com.hexa.engine");
    ...
    async fn rejects_valid_signature_without_openai_signing_identity() {
        ...
        fs::write(
            contents_path.join("Info.plist"),
            r#"<?xml version="1.0"?><plist version="1.0"><dict><key>CFBundleIdentifier</key><string>com.hexa.engine</string><key>CFBundleExecutable</key><string>Codex</string></dict></plist>"#,
        )
        .expect("write Info.plist");
