...
fn update_action_label(context: &InstallContext) -> &'static str {
    match &context.method {
        InstallMethod::Npm => "Hexa staged upstream updater",
        InstallMethod::Bun => "Hexa staged upstream updater",
        InstallMethod::Pnpm => "Hexa staged upstream updater",
        InstallMethod::Brew => "Hexa staged upstream updater",
...
mod tests {
    ...
    fn macos_update_probe_uses_the_persisted_production_appcast_feed() {
        ...
        let state_directory = home
            .path()
            .join("Library/Application Support/com.hexa.engine");
    ...
    async fn macos_staged_updates_require_a_newer_matching_extracted_bundle() {
        ...
        for (name, identity, build) in [
            ("newest", "com.hexa.engine", "6268"),
            ("newer", "com.hexa.engine", "6168"),
            ("older", "com.hexa.engine", "6138"),
            ("different", "com.example.other", "9999"),
            ("invalid", "com.hexa.engine", "invalid"),
        ] {
        ...
        write_macos_bundle(&linked, "com.hexa.engine", "9999");
