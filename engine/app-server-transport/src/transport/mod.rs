...
const APP_SERVER_CONTROL_SOCKET_DIR_NAME: &str = "hexa-app-server-control";
const APP_SERVER_CONTROL_SOCKET_FILE_NAME: &str = "hexa-app-server-control.sock";
const APP_SERVER_STARTUP_LOCK_FILE_NAME: &str = "hexa-app-server-startup.lock";
            ...
            let socket_path = if raw_socket_path.is_empty() {
                let codex_home = find_codex_home().map_err(|err| {
                    AppServerTransportParseError::InvalidUnixSocketPath {
                        ...
                        message: format!("failed to resolve HEXA_ENGINE_HOME: {err}"),
                    }
                })?;
