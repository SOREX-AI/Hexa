...
/// Serializes tests that mutate process-wide HEXA_ENGINE_HOME.
///
...
impl TempCodexHome {
    pub(crate) fn new() -> Self {
        ...
        let dir = tempdir().expect("create HEXA_ENGINE_HOME temp dir");
        unsafe {
            std::env::set_var("HEXA_ENGINE_HOME", dir.path());
        }
        Self {
            _guard: guard,
            _dir: dir,
