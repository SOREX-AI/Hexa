...
//!
//! If the keyring is not available or fails, we fall back to HEXA_ENGINE_HOME/.credentials.json which is consistent with other coding CLI agents.
...
const KEYRING_SERVICE: &str = "Hexa MCP Credentials";
