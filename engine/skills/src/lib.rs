...
/// Returns the on-disk cache location for embedded system skills from an absolute HEXA_ENGINE_HOME.
...
/// Installs embedded system skills into `HEXA_ENGINE_HOME/skills/.system`.
///
