...
fn host_only_prompts_preserve_existing_behavior_with_and_without_aliases() {
    let root = "/Users/test/.hexashell/plugins/cache/openai-curated/host-plugin/1.0.0/skills-with-a-long-shared-root";
    ...
    ### Available skills
    - alpha: Alpha skill. (file: /Users/test/.hexashell/plugins/cache/openai-curated/host-plugin/1.0.0/skills-with-a-long-shared-root/alpha/SKILL.md)
    - beta: Beta skill. (file: /Users/test/.hexashell/plugins/cache/openai-curated/host-plugin/1.0.0/skills-with-a-long-shared-root/beta/SKILL.md)
    - gamma: Gamma skill. (file: /Users/test/.hexashell/plugins/cache/openai-curated/host-plugin/1.0.0/skills-with-a-long-shared-root/gamma/SKILL.md)
    ### How to use skills
    ...
    ### Skill roots
    - `r0` = `/Users/test/.hexashell/plugins/cache/openai-curated/host-plugin/1.0.0/skills-with-a-long-shared-root`
    ### Available skills
...
fn path_aliases_are_used_without_budget_pressure_when_they_reduce_prompt_size() {
    let root = "/Users/test/.hexashell/plugins/cache/openai-curated/example/hash/skills";
    let catalog = SkillCatalog {
        entries: vec![
...
fn path_aliases_retain_every_skill_under_budget_pressure() {
    let root = "/Users/test/.hexashell/plugins/cache/openai-curated/example/hash1234567890/skills-with-a-very-long-shared-prefix";
    let entries = (0..12)
        .map(|index| {
...
fn mixed_catalogs_alias_all_skill_sources_under_budget_pressure() {
    ...
    let host_root = "/Users/test/.hexashell/plugins/cache/openai-curated/example/hash1234567890/skills";
    let catalog =
...
fn substantial_description_shortening_emits_warning() {
    ...
    assert_eq!(
        ...
        Some(
            "Skill descriptions were shortened to fit the skills context budget. Hexa Engine can still see every skill, but some descriptions are shorter. Disable unused skills or plugins to leave more room for the rest."
                .to_string()
        )
    );
}
