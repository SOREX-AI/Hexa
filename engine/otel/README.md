...
`hexa-otel` is the OpenTelemetry integration crate for Codex. It provides:
...
let settings = OtelSettings {
    ...
    service_name: "hexa-cli".to_string(),
...
`hexa-otel` also provides `OtelExporter::Statsig`, a shorthand for exporting OTLP/HTTP JSON metrics
