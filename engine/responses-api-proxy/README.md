...
- We leverage [`codex_process_hardening`](https://github.com/openai/codex/blob/main/engine/process-hardening/README.md) so `hexa-responses-api-proxy` is run with standard process-hardening techniques.
