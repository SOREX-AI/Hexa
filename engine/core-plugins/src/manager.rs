...
impl PluginsManager {
    ...
    pub fn new_with_options(
        ...
        // Product restrictions are enforced at marketplace admission time for a given HEXA_ENGINE_HOME:
        ...
        // contents of that HEXA_ENGINE_HOME and does not re-filter configured plugins by product, so
        // already-admitted plugins may continue exposing MCP servers/tools from shared local state.
        //
        // This assumes a single HEXA_ENGINE_HOME is only used by one product.
