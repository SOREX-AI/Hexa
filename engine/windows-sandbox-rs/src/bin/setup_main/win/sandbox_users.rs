...
pub const SANDBOX_USERS_GROUP: &str = "HexaSandboxUsers";
const SANDBOX_USERS_GROUP_COMMENT: &str = "Hexa sandbox internal group (managed)";
...
pub fn resolve_sid_after_provisioning(name: &str) -> Result<Vec<u8>> {
