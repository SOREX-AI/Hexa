...
const SESSION_NAME: &str = "Hexa Windows Sandbox WFP";
const PROVIDER_NAME: &str = "Hexa Windows Sandbox WFP";
const PROVIDER_DESCRIPTION: &str = "Persistent WFP provider for Hexa Windows sandbox filters";
const SUBLAYER_NAME: &str = "Hexa Windows Sandbox WFP";
const SUBLAYER_DESCRIPTION: &str = "Persistent WFP sublayer for Hexa Windows sandbox filters";
