...
use hexa_exec_server_protocol as protocol;
...
pub use hexa_exec_server_protocol::ExecutorCapabilityDiscoverySnapshot;
pub use hexa_exec_server_protocol::ProcessId;
