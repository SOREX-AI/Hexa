...
/// Owns the execution/filesystem environments available to the Hexa Engine runtime.
///
...
impl EnvironmentManager {
    ...
    ///
    /// If `HEXA_ENGINE_HOME/environments.toml` is present, it defines the configured
    ...
    /// Builds a manager from `HEXA_ENGINE_HOME` with an explicit outbound HTTP policy.
