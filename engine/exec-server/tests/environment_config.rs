...
use hexa_exec_server::EnvironmentConfigLayer;
use hexa_exec_server::EnvironmentConfigLayerStack;
use hexa_exec_server::EnvironmentConfigReadParams;
use hexa_exec_server::EnvironmentConfigReadResponse;
...
async fn remote_environment_reads_projected_executor_config() -> anyhow::Result<()> {
    ...
    let dot_codex = project.join(".hexa");
