...
use hexa_exec_server::CAPABILITY_ROOTS_DISCOVER_METHOD;
use hexa_exec_server::CapabilityRootDiscovery;
use hexa_exec_server::CapabilityRootsDiscoverParams;
use hexa_exec_server::CapabilityRootsDiscoverResponse;
...
use hexa_exec_server_protocol::CapabilityRootDiscoverRequest;
