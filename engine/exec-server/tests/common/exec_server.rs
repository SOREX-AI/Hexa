...
pub(crate) struct TestCodexHelperPaths {
    ...
    pub(crate) hexa_linux_sandbox_exe: Option<PathBuf>,
}
...
pub(crate) fn test_codex_helper_paths() -> anyhow::Result<TestCodexHelperPaths> {
    let (helper_binary, hexa_linux_sandbox_exe) = super::current_test_binary_helper_paths()?;
    ...
    V: AsRef<std::ffi::OsStr>,
{
    ...
    child.env("HEXA_ENGINE_HOME", codex_home.path());
    child.envs(env);
