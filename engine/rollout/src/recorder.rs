...
///
/// ```ignore
/// $ jq -C . ~/.hexashell/sessions/rollout-2025-05-07T17-24-21-5973b6c0-94b8-487b-a530-2aeb6098ae0e.jsonl
/// $ fx ~/.hexashell/sessions/rollout-2025-05-07T17-24-21-5973b6c0-94b8-487b-a530-2aeb6098ae0e.jsonl
/// ```
#[derive(Clone)]
...
fn precompute_new_rollout_path(
    ...
    // Resolve ~/.hexashell/sessions/YYYY/MM/DD path.
