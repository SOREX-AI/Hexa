...
fn file_link_keeps_descriptive_label_and_target() {
    let text = render_markdown_text_for_cwd(
        "Your `hexa-engine` launcher [automatically adds those overrides](/home/dev-user/code/openai/project/dotslash-gen/bin/codex:1105), even though you did not specify any.",
