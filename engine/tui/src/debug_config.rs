...
"#,
    ...
    fn debug_config_output_lists_requirement_sources() {
        ...
        let sqlite_home = if cfg!(windows) {
            absolute_path("C:\\Users\\alice\\.hexashell\\state")
        } else {
            absolute_path("/home/alice/.hexashell/state")
        };
        let log_dir = if cfg!(windows) {
            absolute_path("C:\\Users\\alice\\.hexashell\\logs")
        } else {
            absolute_path("/home/alice/.hexashell/logs")
        };
        let model_catalog_json = if cfg!(windows) {
            absolute_path("C:\\Users\\alice\\.hexashell\\models.json")
        } else {
            absolute_path("/home/alice/.hexashell/models.json")
        };
        ...
        let user_file = if cfg!(windows) {
            absolute_path("C:\\users\\alice\\.hexashell\\config.toml")
        } else {
            absolute_path("/home/alice/.hexashell/config.toml")
        };
        let stack = ConfigLayerStack::new(
