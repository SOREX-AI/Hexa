...
impl SlashCommand {
    ...
    pub fn description(self) -> &'static str {
        match self {
            ...
            SlashCommand::Init => "create an AGENTS.md file with instructions for Hexa",
            ...
            SlashCommand::Quit | SlashCommand::Exit => "exit Hexa",
            ...
            SlashCommand::Skills => "use skills to improve how Hexa performs specific tasks",
            ...
            SlashCommand::Personality => "choose a communication style for Hexa",
            ...
            SlashCommand::Permissions => "choose what Hexa is allowed to do",
            ...
            SlashCommand::Logout => "log out of Hexa",
