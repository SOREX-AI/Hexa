...
//! managed HEXA_ENGINE_HOME cache, while custom pets remain entirely user-owned data
//! under `$HEXA_ENGINE_HOME/pets/<pet-id>/pet.json` or legacy avatar directories.
//!
