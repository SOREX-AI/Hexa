...
impl AuthModeWidget {
    ...
    fn render_pick_mode(&self, area: Rect, buf: &mut Buffer) {
        let mut lines: Vec<Line> = if self.bedrock_setup_enabled {
            vec!["  Choose how you want to use Hexa.".into(), "".into()]
        } else {
            vec![
                Line::from(vec![
                    "  ".into(),
                    "Sign in with ChatGPT to use Hexa as part of your paid plan".into(),
                ]),
                Line::from(vec![
                    "  ".into(),
    ...
    fn render_chatgpt_success_message(&self, area: Rect, buf: &mut Buffer) {
        ...
        let lines = vec![
            ...
            "".into(),
            "  Decide how much autonomy you want to grant Hexa".into(),
            docs_line,
            "".into(),
            "  Hexa Engine can make mistakes".into(),
            HyperlinkLine::new(
    ...
    fn render_api_key_configured(&self, area: Rect, buf: &mut Buffer) {
        let lines = vec![
            ...
            "".into(),
            "  Hexa Engine will use usage-based billing with your API key.".into(),
        ];
...
mod tests {
    ...
    async fn bedrock_option_requires_feature_and_api_login_permission() {
        ...
        insta::assert_snapshot!(rows.join("\n"), @r###"
          Choose how you want to use Hexa.
    ...
    fn chatgpt_success_message_renders_osc8_hyperlinks() {
        ...
        ✓ Signed in with your ChatGPT account
          ...
          Decide how much autonomy you want to grant Hexa
          For more details see the Hexa docs

          Hexa Engine can make mistakes
          Review the code it writes and commands it runs
