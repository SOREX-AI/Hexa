...
const MACOS_APP_TOOLTIP: &str = "Hexa Engine is managed by the Hexa desktop shell.";
...
const OTHER_TOOLTIP_NON_MAC: &str = "*New* Build faster with Hexa.";
const FREE_GO_TOOLTIP: &str =
    "*New* For a limited time, Hexa is included in your plan for free – let’s build together.";
...
/// Pick a random tooltip to show to the user when starting Hexa.
    ...
    impl TargetOs {
        const fn current() -> Self {
            if cfg!(target_os = "macos") {
                ...
                // Hexa supports macOS, Windows, and Linux engine targets.
                Self::Linux
            }
        }
    }
...
mod tests {
    ...
    fn desktop_app_tooltip_uses_supported_platform_launcher() {
        ...
        if linux_app_tooltip(LinuxDesktopSession::current()).is_some() {
            ...
            insta::assert_snapshot!(tooltip, @"Hexa Engine is managed by the Hexa desktop shell.");
...
[[announcements]]
content = "Welcome to Hexa! Check out the new onboarding flow."
