...
mod tests {
    ...
    fn sample_items() -> Vec<ExternalAgentConfigMigrationItem> {
        ...
        vec![
            ExternalAgentConfigMigrationItem {
                ...
                description:
                    "Migrate /Users/alex/.claude/settings.json into /Users/alex/.hexashell/config.toml"
                        .to_string(),
                cwd: None,
                details: None,
            },
    ...
    fn sample_items_with_memory() -> Vec<ExternalAgentConfigMigrationItem> {
        ...
        items.insert(
            ...
            ExternalAgentConfigMigrationItem {
                ...
                description: "Migrate memory files from /Users/alex/.claude/projects to /Users/alex/.hexashell/memories/extensions/external_agent_import/resources".to_string(),
                cwd: None,
                details: Some(codex_app_server_protocol::MigrationDetails {
    ...
    fn secondary_source_customize_snapshot() {
        let items = vec![ExternalAgentConfigMigrationItem {
            item_type: ExternalAgentConfigMigrationItemType::Config,
            description:
                "Migrate /Users/alex/.cursor/cli-config.json into /Users/alex/.hexashell/config.toml"
                    .to_string(),
            cwd: None,
            details: None,
        }];
