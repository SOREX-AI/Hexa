...
fn exec_server_env_for_request(
    ...
    Option<hexa_exec_server::ExecEnvPolicy>,
    HashMap<String, String>,
) {
...
fn exec_server_params_for_request(
    ...
    hexa_exec_server::ExecParams {
        ...
        metadata: tool_ctx.map(|ctx| hexa_exec_server::ExecMetadata {
...
impl UnifiedExecProcessManager {
    ...
    pub(crate) async fn open_session_with_exec_env(
        ...
        shell_snapshot: Option<hexa_exec_server::ShellSnapshotRequest>,
        windows_sandbox_proxy_settings_mode: codex_sandboxing::WindowsSandboxProxySettingsMode,
        tty: bool,
