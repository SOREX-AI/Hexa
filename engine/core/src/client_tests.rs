...
use super::fold_developer_messages_into_instructions;
...
#[test]
fn non_openai_developer_messages_are_folded_into_one_instruction_block() {
    let mut input = vec![
        ResponseItem::Message {
            id: None,
            role: "developer".to_string(),
            content: vec![ContentItem::InputText {
                text: "Use the workspace tools.".to_string(),
            }],
            phase: None,
    ...
    let instructions =
        fold_developer_messages_into_instructions(&mut input, "You are helpful.".to_string());
...
#[test]
fn non_openai_system_messages_are_folded_into_one_instruction_block() {
    let mut input = vec![ResponseItem::Message {
        id: None,
        role: "system".to_string(),
        content: vec![ContentItem::InputText {
            text: "resumed system context".to_string(),
        }],
        phase: None,
        internal_chat_message_metadata_passthrough: None,
    }];
    ...
    let instructions =
        fold_developer_messages_into_instructions(&mut input, "base instructions".to_string());

    assert_eq!(instructions, "base instructions\n\nresumed system context");
    assert_eq!(input, Vec::<ResponseItem>::new());
}
