...
const PROTECTED_METADATA_CODEX_PATH_NAME: &str = ".hexa";
...
impl FileSystemSandboxPolicy {
    ...
    pub fn workspace_write(
        ...
        append_default_read_only_project_root_subpath_if_no_explicit_rule(&mut entries, ".hexa");
    ...
    fn get_writable_roots_with_cwd_impl(
        ...
        .map(|root| {
            ...
            WritableRoot {
                ...
                // `.hexa` so downstream sandboxes can still detect and mask
...
mod tests {
    ...
    fn uri_deny_and_metadata_matcher_use_executor_paths() {
        ...
        let policy = FileSystemSandboxPolicy::restricted(vec![
            ...
            FileSystemSandboxEntry::new(
                path("file:///C:/workspace/.hexa").into(),
                FileSystemAccessMode::Read,
            ),
        ...
        assert!(!policy.can_write_path(&path("file:///C:/workspace/.hexa/config"), &context));
        assert_eq!(
            policy.metadata_write_denial(&path("file:///C:/workspace/.hexa/config"), &context),
            Some(".hexa"),
        );
    }
    ...
    fn writable_roots_proactively_protect_missing_dot_codex() {
        ...
        let expected_dot_codex = expected_root.join(".hexa");
    ...
    fn legacy_workspace_write_projection_preserves_symbolic_project_root() {
        ...
        assert_eq!(
            ...
            FileSystemSandboxPolicy::restricted(vec![
                ...
                FileSystemSandboxEntry::skip_missing_path(
                    FileSystemPath::Special {
                        value: FileSystemSpecialPath::project_roots(Some(".hexa".into())),
                    },
                    FileSystemAccessMode::Read,
                ),
            ])
    ...
    fn writable_roots_skip_default_dot_codex_when_explicit_user_rule_exists() {
        ...
        .expect("absolute canonical root");
        let explicit_dot_codex = expected_root.join(".hexa");
    ...
    fn filesystem_policy_blocks_protected_metadata_path_writes_by_default() {
        ...
        let dot_codex_config = cwd.path().join(".hexa").join("config.toml");
    ...
    fn legacy_workspace_write_projection_accepts_relative_cwd() {
        ...
        assert!(
            !file_system_policy
                .can_write_local_path_with_cwd(Path::new(".hexa/config.toml"), relative_cwd,)
        );
    ...
    fn effective_runtime_roots_preserve_symlinked_paths() {
        ...
        let codex_dir = real_root.join(".hexa");
        ...
        let expected_codex = link_root.join(".hexa");
    ...
    fn project_roots_special_path_preserves_symlinked_root() {
        ...
        let expected_codex = expected_root.join(".hexa");
    ...
    fn tmpdir_special_path_preserves_symlinked_tmpdir() {
        ...
        let codex_dir = real_tmpdir.join(".hexa");
