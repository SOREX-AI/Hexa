...
const actions = {
  ...
  'upstream-clean': ['scripts/clean-upstream-trees.mjs'],
...
try {
  if (action === 'help' || action === '--help' || action === '-h') {
    ...
    if (!hasShellDependencies() && !['check', 'clean', 'engine-check', 'engine-build', 'protocol-sync', 'upstream-update', 'upstream-clean', 'version-import'].includes(action)) {
