...
Some upstream documents may temporarily exist under the ignored `vendor/upstream-engine-reference/` update-review tree. That disposable tree can be removed with `node hexa.mjs upstream-clean`; this `docs/` folder is the canonical, tracked location for Hexa documentation.
