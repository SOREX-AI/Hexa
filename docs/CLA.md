# Upstream OpenAI Codex CLA reference

> **Not a Hexa agreement.** This historical document is retained because the Rust engine is derived from the OpenAI Codex repository. It governs neither Hexa contributors nor contributions to `SOREX-AI/Hexa`; do not sign it for Hexa work.
