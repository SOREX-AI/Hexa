## Upstream Codex CLI installation and building reference

> **Upstream reference only.** The commands below clone and build OpenAI Codex CLI, not Hexa. For Hexa development or packaging, use [Build and run Hexa](BUILDING.md) from this repository instead.
