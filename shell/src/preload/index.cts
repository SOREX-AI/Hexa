...
const bridge: HexaBridge = {
  ...
  listCuratedSkills: () => ipcRenderer.invoke('shell:list-curated-skills'),
  installCuratedSkill: (name) => ipcRenderer.invoke('shell:install-curated-skill', name),
  importSkill: () => ipcRenderer.invoke('shell:import-skill'),
  importPlugin: () => ipcRenderer.invoke('shell:import-plugin'),
